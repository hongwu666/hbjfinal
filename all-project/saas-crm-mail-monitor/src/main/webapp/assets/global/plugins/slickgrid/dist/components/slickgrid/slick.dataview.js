(function ($) {
  ...
  function DataView(options) {
    ...
    // private
    // TODO JACKY 2013 10 08  修改idProperty  增加自动count = 1;
    var __count = 1;
    var idProperty = "__id";  // property holding a unique row id
    ...
    function insertItem(insertBefore, item) {
   	 //TODO JACKY 2013 10 08 
        item[idProperty] = "__id_" + __count++;
